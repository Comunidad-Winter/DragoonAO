...
Public RG(1 To 8, 1 To 3) As Byte
...
frmPres.Picture = LoadPicture(App.Path & "\Graficos\Dragoon.jpg")
...
Do While prgRun
    ...
    End If
        ...
        If DirectX.TickCount - lFrameTimer > 1000 Then
            ...
            If FPSFLAG Then frmMain.Caption = "Dragoon AO" & " V " & App.Major & "." & App.Minor & "." & App.Revision
            frmMain.fpstext.Caption = FramesPerSec
            If FramesPerSec < 4 And FramesPerSec > 1 Then MsgBox "FPS Bajos"
