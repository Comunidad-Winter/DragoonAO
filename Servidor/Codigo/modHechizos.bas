...
If Hechizos(H).Invisibilidad = 1 And Not UserList(UserIndex).POS.Map = 190 And Not UserList(UserIndex).POS.Map = 191 And Not UserList(UserIndex).POS.Map = 197 And Not UserList(UserIndex).POS.Map = 198 And Not UserList(UserIndex).POS.Map = 200 And Not UserList(UserIndex).POS.Map = 201 And Not UserList(UserIndex).POS.Map = 202 And Not UserList(UserIndex).POS.Map = 203 And Not UserList(UserIndex).POS.Map = 204 And Not UserList(UserIndex).POS.Map = 196 Then
