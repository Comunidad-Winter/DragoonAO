...
Public SistemaSoporte As Boolean
Public SistemaDeathmatch As Boolean
Public SistemaRetos As Boolean
Public AutoTorneo As Boolean
Public ModoDeath As Boolean
...
'2 vs 2
Public HayDueloDos As Boolean
Public DuelistaUno As Boolean
Public DuelistaDos As Boolean
Public DuelistaTres As Boolean
Public DuelistaCuatro As Boolean
'2 vs 2
...
Public Const FONTTYPE_DUELOS = "~255~0~255~0~0"
...
Type UserFlags
    '2 vs 2
    EnDuelo As Boolean
    NumPareja As Integer
    iDuelistaUno As Boolean
    iDuelistaDos As Boolean
    iDuelistaTres As Boolean
    iDuelistaCuatro As Boolean
    '2 vs 2
