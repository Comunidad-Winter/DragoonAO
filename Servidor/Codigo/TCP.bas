...
UserList(UserIndex).Invent.Object(6).OBJIndex = 474
UserList(UserIndex).Invent.Object(6).Amount = 2
...
If UserList(UserIndex).flags.DueLeanDo = True Then
    ...
    Call WarpUserChar(UserIndex, 98, 39, 53, True)
End If

'2 vs 2
If UserList(UserIndex).flags.EnDuelo = True Then
    If UserList(UserIndex).flags.iDuelistaUno = True Then
        Call SendData(ToAll, UserIndex, 0, "||Se ha desconectado " & UserList(UserIndex).Name & FONTTYPE_DUELOS)
        UserList(UserIndex).flags.EnDuelo = False
        UserList(UserIndex).flags.NumPareja = 0
        UserList(UserIndex).flags.iDuelistaUno = False
        DuelistaUno = False
    End If
    If UserList(UserIndex).flags.iDuelistaDos = True Then
        Call SendData(ToAll, UserIndex, 0, "||Se ha desconectado " & UserList(UserIndex).Name & FONTTYPE_DUELOS)
        UserList(UserIndex).flags.EnDuelo = False
        UserList(UserIndex).flags.NumPareja = 0
        UserList(UserIndex).flags.iDuelistaDos = False
        DuelistaDos = False
    End If
    If UserList(UserIndex).flags.iDuelistaTres = True Then
        Call SendData(ToAll, UserIndex, 0, "||Se ha desconectado " & UserList(UserIndex).Name & FONTTYPE_DUELOS)
        UserList(UserIndex).flags.EnDuelo = False
        UserList(UserIndex).flags.NumPareja = 0
        UserList(UserIndex).flags.iDuelistaTres = False
        DuelistaTres = False
    End If
    If UserList(UserIndex).flags.iDuelistaCuatro = True Then
        Call SendData(ToAll, UserIndex, 0, "||Se ha desconectado " & UserList(UserIndex).Name & FONTTYPE_DUELOS)
        UserList(UserIndex).flags.EnDuelo = False
        UserList(UserIndex).flags.NumPareja = 0
        UserList(UserIndex).flags.iDuelistaCuatro = False
        DuelistaCuatro = False
    End If
    If DuelistaUno = False And DuelistaDos = False And DuelistaTres = True Or DuelistaCuatro = True Then
        Call SendData(ToAll, UserIndex, 0, "||2 vs 2> Gana la Pareja Numero 1" & FONTTYPE_DUELOS)
        HayDueloDos = False
    End If
    If DuelistaUno = True Or DuelistaDos = True And DuelistaTres = False And DuelistaCuatro = False Then
        Call SendData(ToAll, UserIndex, 0, "||2 vs 2> Gana la Pareja Numero 2" & FONTTYPE_DUELOS)
        HayDueloDos = False
    End If
    Call SendData(ToIndex, UserIndex, 0, "||Has Sido enviado a Arghal" & FONTTYPE_INFO)
    Call WarpUserChar(UserIndex, 98, 39, 53, True)
End If
'2 vs 2


If UserList(UserIndex).POS.Map = 199 Then
    Call SendData(ToAll, UserIndex, 0, "||El Usuario " & UserList(UserIndex).Name & " se ha Deslogeado en Deathmatch" & FONTTYPE_WARNING)
    Call WarpUserChar(UserIndex, 98, 39, 53, True)
End If
...
Call SendData(ToIndex, UserIndex, 0, "LOGEANDO")
...
Call SendData(ToIndex, UserIndex, 0, "||Bienvenido a DragoonAO Online" & FONTTYPE_INTRO)
Call SendData(ToIndex, UserIndex, 0, "||Haber ingresado al DragoonAO, significa que has Aceptado el Reglamento de la Pagina Oficial" & FONTTYPE_INTRO)
Call SendData(ToIndex, UserIndex, 0, "||http://dragoon-ao.com.ar | http://foro.dragoon-ao.com.ar" & FONTTYPE_INTRO)
...
If UCase$(Left$(rdata, 8)) = "/CANJEO " Then
    ...
    If rdata = "T1" Then
        If UserList(UserIndex).Faccion.Quests >= 15 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 837 'Numero de Item
        ...
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 15
        End If
    End If
    If rdata = "T2" Then
        If UserList(UserIndex).Faccion.Quests >= 15 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 841 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 15
        End If
    ...
    If rdata = "T3" Then
        If UserList(UserIndex).Faccion.Quests >= 15 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 842 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 15
        End If
    ...
    If rdata = "T4" Then
        If UserList(UserIndex).Faccion.Quests >= 15 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 843 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 15
        End If
    ...
    If rdata = "T5" Then
        If UserList(UserIndex).Faccion.Quests >= 15 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 844 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 15
        End If
    End If
    If rdata = "T6" Then
        If UserList(UserIndex).Faccion.Quests >= 20 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 846 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 20
        End If
    End If
    If rdata = "T7" Then
        If UserList(UserIndex).Faccion.Quests >= 20 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 845 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 20
        End If
    End If
    If rdata = "T8" Then
        If UserList(UserIndex).Faccion.Quests >= 50 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 847 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 50
        End If
    End If
    If rdata = "T9" Then
        If UserList(UserIndex).Faccion.Quests >= 45 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 854 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 45
        End If
    End If
    If rdata = "T10" Then
        If UserList(UserIndex).Faccion.Quests >= 45 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 855 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 45
        End If
    ...
    If rdata = "T11" Then
        If UserList(UserIndex).Faccion.Quests >= 45 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 856 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 45
        End If
    ...
    If rdata = "T12" Then
        If UserList(UserIndex).Faccion.Quests >= 50 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 861 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 50
        End If
    ...
    If rdata = "T17" Then
        If UserList(UserIndex).Faccion.Quests >= 45 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 839 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 45
        End If
    ...
    If rdata = "T18" Then
        If UserList(UserIndex).Faccion.Quests >= 45 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 840 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 45
        End If
    ...
    If rdata = "T19" Then
        ...
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 816 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 4
        End If
    End If
    If rdata = "T20" Then
        If UserList(UserIndex).Faccion.Quests >= 4 Then
    ...
    If rdata = "T22" Then
        If UserList(UserIndex).Faccion.Quests >= 50 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 885 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 50
        End If
    ...
    If rdata = "T23" Then
        If UserList(UserIndex).Faccion.Quests >= 50 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 859 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 50
        End If
    End If
    If rdata = "T24" Then
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 906 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
    End If
    If rdata = "T25" Then
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 907 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
    ...
    If rdata = "T26" Then
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 880 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
    ...
    If rdata = "T28" Then
        ...
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 5
        End If
    End If
    If rdata = "T29" Then
        If UserList(UserIndex).Faccion.Quests >= 10 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 851 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 10
        End If
    End If
    If rdata = "T30" Then
        If UserList(UserIndex).Faccion.Quests >= 30 Then
    ...
    If rdata = "T32" Then
        If UserList(UserIndex).Faccion.Quests >= 30 Then
        superoro.Amount = 1 'Cantidad de Items
        superoro.OBJIndex = 850 'Numero de Item
        If Not MeterItemEnInventario(UserIndex, superoro) Then Call TirarItemAlPiso(UserList(UserIndex).POS, superoro)
        Call SendData(ToIndex, UserIndex, 0, "||¡Has Obtenido un Item. Se te ha descontado de tus Puntos de Canje!" & FONTTYPE_INFO)
        UserList(UserIndex).Faccion.Quests = UserList(UserIndex).Faccion.Quests - 30
        End If
...
If UCase$(Left$(rdata, 8)) = "/PAREJA " Then
    ...
    If SistemaRetos = False Then
        Call SendData(ToIndex, UserIndex, 0, "||Sistema No Activado" & FONTTYPE_INFO)
        Exit Sub
    End If
    'If UserList(UserIndex).POS.Map = 206 Or UserList(TIndex).POS.Map = 206 Then
    '    Call SendData(ToIndex, UserIndex, 0, "||No Disponible" & FONTTYPE_INFO)
    '    Exit Sub
    'End If
    'If UserList(UserIndex).flags.EnDuelo = True Or UserList(UserIndex).flags.EnDuelo = True Then
    '    Call SendData(ToIndex, UserIndex, 0, "||Estas en el 2 vs 2" & FONTTYPE_INFO)
    '    Exit Sub
    'End If
    'If HayDueloDos = True Then
    '    Call SendData(ToIndex, UserIndex, 0, "||Ya hay un Duelo" & FONTTYPE_INFO)
    '    Exit Sub
    'End If
    If MapInfo(206).NumUsers = 0 Then
        Call SendData(ToAll, UserIndex, 0, "||2 vs 2>" & UserList(UserIndex).Name & " y " & UserList(TIndex).Name & " esperan en sala de 2 vs 2" & FONTTYPE_DUELOS)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido enviado a la Sala 2 vs 2, para Salir Utiliza /SALIRDUELO" & FONTTYPE_INFO)
        Call WarpUserChar(UserIndex, 206, 41, 55, True)
        UserList(UserIndex).flags.NumPareja = 1
        UserList(UserIndex).flags.EnDuelo = True
        UserList(UserIndex).flags.iDuelistaUno = True
        DuelistaUno = True
        Call SendData(ToIndex, TIndex, 0, "||Has sido enviado a la Sala 2 vs 2, para Salir Utiliza /SALIRDUELO" & FONTTYPE_INFO)
        Call WarpUserChar(TIndex, 206, 43, 55, True)
        UserList(TIndex).flags.NumPareja = 1
        UserList(TIndex).flags.EnDuelo = True
        UserList(UserIndex).flags.iDuelistaDos = True
        DuelistaDos = True
        Exit Sub
    Else
        If MapInfo(206).NumUsers = 2 Then
            Call SendData(ToAll, UserIndex, 0, "||2 vs 2>" & UserList(UserIndex).Name & " y " & UserList(TIndex).Name & " ingresaron al 2 vs 2" & FONTTYPE_DUELOS)
            Call SendData(ToAll, UserIndex, 0, "||Comienza la Batalla!" & FONTTYPE_DUELOS)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido enviado a la Sala 2 vs 2, para Salir Utiliza /SALIRDUELO" & FONTTYPE_INFO)
            Call WarpUserChar(UserIndex, 206, 62, 40, True)
            UserList(UserIndex).flags.NumPareja = 2
            UserList(UserIndex).flags.EnDuelo = True
            UserList(UserIndex).flags.iDuelistaTres = True
            DuelistaTres = True
            Call SendData(ToIndex, TIndex, 0, "||Has sido enviado a la Sala 2 vs 2, para Salir Utiliza /SALIRDUELO" & FONTTYPE_INFO)
            Call WarpUserChar(TIndex, 206, 64, 40, True)
            UserList(TIndex).flags.NumPareja = 2
            UserList(TIndex).flags.EnDuelo = True
            UserList(TIndex).flags.iDuelistaCuatro = True
            DuelistaCuatro = True
            'Comienzo el Duelo en Global
            HayDueloDos = True
            'Comienzo el Duelo en Global
            Exit Sub
        End If
...
If UCase$(rdata) = "/SALA1" Then
    If UserList(UserIndex).POS.Map <> 62 Then
        Call SendData(ToIndex, UserIndex, 0, "||Debes estar en la Ciudad Lindos para Jugar" & FONTTYPE_INFO)
        Exit Sub
    End If
    If UserList(UserIndex).flags.DueLeanDo = True Then
    ...
    If UserList(UserIndex).flags.Encarcelado = 1 Then
        Call SendData(ToIndex, UserIndex, 0, "||Estas en la Carcel MANCHO-PANCHO!" & FONTTYPE_INFO)
        Exit Sub
    End If
    If UserList(UserIndex).flags.Muerto = 1 Then
    ...
    If MapInfo(192).NumUsers = 0 Then
        ...
        Exit Sub
    Else
        If MapInfo(192).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 192, 43, 54, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
...
If UCase$(rdata) = "/SALA2" Then
    ...
    If EsNewbie(UserIndex) Then
        ...
        Exit Sub
    End If
    If MapInfo(193).NumUsers >= 2 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala Llena." & FONTTYPE_FENIX)
        Exit Sub
    End If

    If MapInfo(193).NumUsers = 0 Then
        Call SendData(ToAll, 0, 0, "||Sala 2>" & UserList(UserIndex).Name & " espera contrincante en la sala de Duelos!" & FONTTYPE_FENIX)
        Call WarpUserChar(UserIndex, 193, 61, 41, True)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /SALIRDUELO" & FONTTYPE_INFO)
        UserList(UserIndex).flags.DueLeanDo = True
        Exit Sub
    Else
        If MapInfo(193).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 193, 43, 54, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
...
If UCase$(rdata) = "/SALA3" Then
    ...
    If EsNewbie(UserIndex) Then
        ...
        Exit Sub
    End If
    If MapInfo(194).NumUsers >= 2 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala Llena." & FONTTYPE_FENIX)
        Exit Sub
    End If

    If MapInfo(194).NumUsers = 0 Then
        Call SendData(ToAll, 0, 0, "||Sala 3>" & UserList(UserIndex).Name & " espera contrincante en la sala de Duelos!" & FONTTYPE_FENIX)
        Call WarpUserChar(UserIndex, 194, 61, 41, True)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /SALIRDUELO" & FONTTYPE_INFO)
        UserList(UserIndex).flags.DueLeanDo = True
        Exit Sub
    Else
        If MapInfo(194).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 194, 43, 54, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
            Call SendData(ToAll, 0, 0, "||Sala 3> Comenzara la Batalla!" & FONTTYPE_FENIX)
            Exit Sub
        End If
    End If
End If

If UCase$(rdata) = "/SALA4" Then
    If UserList(UserIndex).POS.Map <> 62 Then
        Call SendData(ToIndex, UserIndex, 0, "||Debes estar en la Ciudad Lindos para Jugar" & FONTTYPE_INFO)
        Exit Sub
    End If
    ...
    If MapInfo(195).NumUsers = 0 Then
        Call SendData(ToAll, 0, 0, "||Sala 4>" & UserList(UserIndex).Name & " espera contrincante en la sala de Duelos!" & FONTTYPE_FENIX)
        Call WarpUserChar(UserIndex, 195, 61, 41, True)
        Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /SALIRDUELO" & FONTTYPE_INFO)
        UserList(UserIndex).flags.DueLeanDo = True
        Exit Sub
    Else
        If MapInfo(195).NumUsers = 1 Then
            Call WarpUserChar(UserIndex, 195, 43, 54, True)
            Call SendData(ToIndex, UserIndex, 0, "||Has sido llevado a la sala de Duelos! cuando quieras salir, teclea: /ABANDONARSALA" & FONTTYPE_INFO)
            UserList(UserIndex).flags.DueLeanDo = True
            Call SendData(ToAll, 0, 0, "||Sala 4> Comenzara la Batalla!" & FONTTYPE_FENIX)
            Exit Sub
        End If
    End If
End If
...
If UCase$(rdata) = "/INFSALAS" Then
    ...
    End If
    If MapInfo(194).NumUsers = 0 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala 3. Disponible" & FONTTYPE_INFO)
    End If
    If MapInfo(194).NumUsers = 1 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala 3. Esperando Oponente" & FONTTYPE_INFO)
    End If
    If MapInfo(194).NumUsers = 2 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala 3. Llena" & FONTTYPE_INFO)
    End If
    If MapInfo(195).NumUsers = 0 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala 4. Disponible" & FONTTYPE_INFO)
    End If
    If MapInfo(195).NumUsers = 1 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala 4. Esperando Oponente" & FONTTYPE_INFO)
    End If
    If MapInfo(195).NumUsers = 2 Then
        Call SendData(ToIndex, UserIndex, 0, "||Sala 4. Llena" & FONTTYPE_INFO)
    End If
    Exit Sub
End If
...
If UCase$(rdata) = "/SALIRDUELO" Then
    If UserList(UserIndex).flags.DueLeanDo = True Then
        ...
        Call SendData(ToIndex, UserIndex, 0, "||Has Abandonado la Sala y Enviado a IP" & FONTTYPE_FENIX)
        Call WarpUserChar(UserIndex, 160, 37, 28, True)
    End If
    '2 vs 2
    If UserList(UserIndex).flags.EnDuelo = True Then
    If UserList(UserIndex).flags.iDuelistaUno = True Then
        Call SendData(ToAll, UserIndex, 0, "||Abandono " & UserList(UserIndex).Name & FONTTYPE_DUELOS)
        UserList(UserIndex).flags.EnDuelo = False
        UserList(UserIndex).flags.NumPareja = 0
        UserList(UserIndex).flags.iDuelistaUno = False
        DuelistaUno = False
...
If UCase$(Left$(rdata, 8)) = "/CONMSJ " Then
    rdata = Right$(rdata, Len(rdata) - 8)
    If UserList(UserIndex).flags.EsConseCaos = True Then
        Call SendData(ToAll, UserIndex, 0, "||Concilio de DragoonAO > " & rdata & FONTTYPE_CONSEJOCAOS)
        Exit Sub
    End If
    If UserList(UserIndex).flags.EsConseReal = True Then
        Call SendData(ToAll, UserIndex, 0, "||Concejo de DragoonAO > " & rdata & FONTTYPE_CONSEJO)
        Exit Sub
    End If
    Exit Sub
End If
...
If UCase$(Left$(rdata, 11)) = "/RESPONDER " Then
    ...
    Else
        ...
        Call SendData(ToIndex, TIndex, 0, "||" & Respuesta & FONTTYPE_VENENO)
        Call SendData(ToAdmins, UserIndex, 0, "||Respuesta de Soporte enviada a " & Name & FONTTYPE_TALK)
    End If
    Exit Sub
End If
...
If UCase$(Left$(rdata, 7)) = "/SEGURO" Then
        If MapInfo(UserList(UserIndex).POS.Map).Pk = True Then
            ...
            Call SendData(ToAdmins, UserIndex, 0, "||Ahora es zona segura." & FONTTYPE_INFO)
            Exit Sub
        Else
            MapInfo(UserList(UserIndex).POS.Map).Pk = True
            Call SendData(ToAdmins, UserIndex, 0, "||Ahora es zona insegura." & FONTTYPE_INFO)
            Exit Sub
        End If
        Exit Sub
    End If
...
If UCase$(Left$(rdata, 7)) = "/TORNEO" Then
    If entorneo = 0 Then
        ...
        Call SendData(ToAll, UserIndex, 0, "||Modo Torneo. Envia /PARTICIPAR" & FONTTYPE_FENIX)
    Else
        entorneo = 0
        Call SendData(ToAll, UserIndex, 0, "||Torneo Desactivado" & FONTTYPE_WARNING)
    End If
    Exit Sub
End If
...
If UCase$(rdata) = "/QUEST" Then
    If ModoDeath = False Then
        Call SendData(ToAll, 0, 0, "||Sistema de Deathmatch Activado." & FONTTYPE_FENIX)
        Call SendData(ToAll, 0, 0, "||Para Ingresar, tipea /INGRESAR" & FONTTYPE_FENIX)
        ModoDeath = True
        Exit Sub
    End If
    If ModoDeath = True Then
        Call SendData(ToAll, 0, 0, "||Sistema de Deathmatch Desactivado." & FONTTYPE_WARNING)
        ModoDeath = False
        Exit Sub
    End If
End If
...
If UCase$(rdata) = "/SISTEMASOPORTE" Then
    If SistemaSoporte = False Then
        SistemaSoporte = True
        Call SendData(ToAll, 0, 0, "||Soporte Activado." & FONTTYPE_FENIX)
        Call SendData(ToAll, 0, 0, "||Funciona con el Comando. /SOPORTE MENSAJE. No abuses de Ellos" & FONTTYPE_FENIX)
        Exit Sub
    End If
    If SistemaSoporte = True Then
        SistemaSoporte = False
        Call SendData(ToAll, 0, 0, "||Soporte Desactivado." & FONTTYPE_FENIX)
        Exit Sub
    End If
Exit Sub
End If

If UCase$(rdata) = "/SISTEMADEATHMATCH" Then
    If SistemaDeathmatch = False Then
        SistemaDeathmatch = True
        Call SendData(ToAll, 0, 0, "||Deathmatch Activado." & FONTTYPE_FENIX)
        Call SendData(ToAll, 0, 0, "||Entra al Deathmatch. Clickeando al NPC de Deathmatch" & FONTTYPE_FENIX)
        Exit Sub
    End If
    If SistemaDeathmatch = True Then
        SistemaDeathmatch = False
        Call SendData(ToAll, 0, 0, "||Deathmatch Desactivado." & FONTTYPE_FENIX)
        Exit Sub
    End If
Exit Sub
End If

If UCase$(rdata) = "/SISTEMARETOS" Then
    If SistemaRetos = False Then
        SistemaRetos = True
        Call SendData(ToAll, 0, 0, "||Duelos 2 vs 2 Activado." & FONTTYPE_FENIX)
        Call SendData(ToAll, 0, 0, "||Para Administrar el 2 vs 2, ingresa /RETO" & FONTTYPE_FENIX)
        Exit Sub
    End If
    If SistemaRetos = True Then
        SistemaRetos = False
        Call SendData(ToAll, 0, 0, "||Duelos 2 vs 2 Desactivado." & FONTTYPE_FENIX)
        Exit Sub
    End If
Exit Sub
End If
    ...
    'If UserList(UserIndex).Flags.EsConseReal/Caos > 0 Or UserList(UserIndex).flags.Privilegios > 1 Then
        ...
        Else
            ...
            If UserList(TIndex).flags.EsConseReal = 0 And UserList(TIndex).flags.EsConseCaos = 0 Then
                Call SendData(ToIndex, UserIndex, 0, "||" & rdata & " no es consejero ni pertenece al Concilio." & FONTTYPE_FENIX)
            End If
        End If
    End If
    Exit Sub
